...
const Home = () => {
  ...
  return (
    <PrimaryLayout>
      <div className="page-container bg-black overflow-hidden md:min-h-[calc(100vh-5rem)] min-h-[calc(87vh-5rem)] relative">
        {/* Slider container with calc for viewport height minus footer */}
        <div className="slider-container relative w-full md:h-[calc(100vh-5rem)] h-[calc(87vh-5rem)] overflow-hidden">
